...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/store')) {
            ...
            // acme_store_remove
            if (0 === strpos($pathinfo, '/store/remove') && preg_match('#^/store/remove/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'acme_store_remove')), array (  '_controller' => 'Acme\\StoreBundle\\Controller\\DefaultController::removeAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            // acme_hello_helloo
            if ($pathinfo === '/helloo/hello') {
                return array (  '_controller' => 'Acme\\HelloBundle\\Controller\\HelloController::indexAction',  '_route' => 'acme_hello_helloo',);
            }
        ...
        if (0 === strpos($pathinfo, '/demo')) {
            ...
            // _demo_hello
            if (0 === strpos($pathinfo, '/demo/hello') && preg_match('#^/demo/hello/(?P<imie>[^/]++)/(?P<nazwisko>[^/]++)$#s', $pathinfo, $matches)) {
